...
export const useReportsTableTour = () => {
  ...
  const steps = [
    {
      ...
      description:
        'Ao clicar nesse botão, você será redirecionado para a tela de cadastro de Laudos onde poderá cadastra-los.',
      target: () => ref1.current,
    },
    {
      title: 'Pesquisar!',
      description:
        'Campo de pesquisa para facilitar a busca de um Laudo específico.',
      target: () => ref2.current,
    },
    {
      title: 'Gerar EXCEL!',
    ...
    },
    {
      ...
      description: 'Aqui você pode visualizar todos os Laudos cadastrados.',
      target: () => ref6.current,
    },
  ];
